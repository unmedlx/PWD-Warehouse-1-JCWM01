  ...
  return (
    <>
      <div className="profile-sidebar">
        ...
        <ProfileNavbar />
        <button className="button-profile" onClick={handleShow}>
        ...
        <div className="profile-photo-desc mt-3">
          <p className="text-smallest subtitle-500">
            Maximum image size is 5 Megabytes. File extention that supported
            are: .JPG .JPEG .PNG
          </p>
        </div>
      </div>
