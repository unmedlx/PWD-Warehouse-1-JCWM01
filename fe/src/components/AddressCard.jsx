...
const AddressCard = ({ provinces, address }) => {
  ...
  const deleteBtnHandler = () => {
    try {
      dispatch(DeleteAddress(address.idAddress, userLocalStorage));
    ...
    <>
      <div className="address-card">
        <div>
          ...
          <a className="address-edit setting" onClick={handleShow}>
            Edit
          </a>
          <a className="address-delete setting" onClick={deleteBtnHandler}>
            Delete
          </a>
        </div>
      </div>
