        ...
        <div className="navbar-container">
            ...
            <nav className="nav-link-container">
                <ul className="nav-links m-0 p-0">
                    <li><a href="/" className="nav-link-cta subtitle-600">Home</a></li>
                    <li><a href="/product-list" className="nav-link-cta subtitle-600">Products</a></li>
                    <li><a href="" className="nav-link-cta subtitle-600">About</a></li>
                </ul>
            </nav>
            <div className="auth">
                <div>
