...
export const LoggedInRoute = [
    ...
    { component: DetailTransaction, path: "/transaction/detail/:idTransaction", exact: true },
...
export const AdminRoute = [
    ...
    { component: AdminEditProduct, path: "/edit-product/:idProduct", exact: true },
    { component: AdminViewTransaction, path: "/admin-transaction", exact: true },
    { component: DetailTransaction, path: "/admin-transaction-detail/:idTransaction", exact: true },
    { component: WarehouseStock, path: "/admin-warehouse", exact: true },
    { component: SalesReport, path: "/sales-report", exact: true },
]

export const SuperAdminRoute = [
    { component: SuperAdminViewTransaction, path: "/super-admin-transaction", exact: true },
